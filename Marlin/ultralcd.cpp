...
static void lcd_control_retract_menu()
{
    ...
    MENU_ITEM_EDIT(float52, MSG_CONTROL_RETRACT, &retract_length[active_extruder], 0, 100);
    MENU_ITEM_EDIT(float3, MSG_CONTROL_RETRACTF, &retract_feedrate[active_extruder], 1, 999);
