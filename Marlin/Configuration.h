...
#define X_CENTER_POS (X_MAX_LENGTH / 2)
#define Y_CENTER_POS (Y_MAX_LENGTH / 2)
...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {128.0,128.0,400,369}  // default steps per unit for ultimaker2.1 JarJar
